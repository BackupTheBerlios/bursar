...
/**
  ...
  */
QString Utils::boolToStr(bool value)
{
    if (value) {
        return "true";
    } else {
...
/**
  ...
  */
QString Utils::intToStr(int value)
{
...
/**
  ...
  */
QString Utils::addFileExtension(const QString &fileName, const QString &extension)
{
...
/**
  ...
  */
void Utils::setFieldSizes(QLineEdit *lineEdit, int size)
{
